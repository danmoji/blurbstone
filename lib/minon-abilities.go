...
Charge
Spell Damage + 1
Battle cry Deal 1 damage
Your other Murlocs habe +1 Attack
...
Battlecry: Summon 2/1 Mechanical Dragonling
...
func PlussSpellDamage(plusDamage int) {
	// id 6
	// can be +1 +2 ...
}

func BattleCryDealDamage(damage int) {
	// id 7
}
